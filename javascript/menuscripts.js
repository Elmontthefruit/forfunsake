...
let cancion2=' <div class="itemcancion d-flex m-auto"><img src="img/bomato.gif" class="imgitemcancion pe-5 "><div class="infoitemscancion pt-2"><span class="titulocancion">¡A implementar! <br></span><span class="tituloAlbum ps-1">???<br></span><span class="dificultadcancion ps-2" ><i class="bi bi-star"></i><i class="bi bi-star"></i><i class="bi bi-star"></i><i class="bi bi-star"></i><i class="bi bi-star"></i></span></div></div>';
...
function cambiarModal(idseccion){
    if (idseccion==1) {
        ...
        document.getElementById("infoModal").innerHTML='<a href="JavaScript:cambiarModalEspecifico(1)">'+cancion1+ '</a><br><a href="JavaScript:cambiarModalEspecifico(1)">'+cancion1+ '</a>';
...
function cambiarModalEspecifico(idsubsecc){
    document.getElementById("infoModalEspecifico").innerHTML=" ";
}