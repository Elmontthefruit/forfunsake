        ...
        <div class="container degradado-azulCentral">
            <div class="row horizontalMedio px-3 ">
                ...
                <div class="col-2   text-center p-0 ">
                    ...
                    <a href="JavaScript:cambiarModal(1)">
                        <div class="opciones opcion1Lat degradadoOpcionesLat">Niveles</div>
                    </a>
                    <a href="JavaScript: modaldelusuario(varJS1,varJS2,varJS3,varJSp0, varJSp1, varJSp2)">
                        <div class="opciones opcion2Lat degradadoOpcionesLat">Jugador</div>
                    </a>
                   
                    <a href="index.php">
                        <div class="opciones opcion4Lat degradadoOpcionesLat">Salir</div>
                    </a>
                    <a href="JavaScript:cambiarModal(4)">
                        <div class="opciones opcion5Lat degradadoOpcionesLat">Acerca de...</div>
                    </a>
                </div>
